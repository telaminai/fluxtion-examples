...
public class GlobalPnlProcessor
  ...
  //Node declarations
  private final transient BookPnl bookPnl_book1 = new BookPnl("book1");
  private final transient BookPnl bookPnl_bookAAA = new BookPnl("bookAAA");
  private final transient BookPnl bookPnl_book_XYZ = new BookPnl("book_XYZ");
  private final transient CallbackDispatcherImpl callbackDispatcher = new CallbackDispatcherImpl();
  public final transient Clock clock = new Clock();
  private final transient GlobalPnl globalPnl =
      new GlobalPnl(Arrays.asList(bookPnl_book1, bookPnl_bookAAA, bookPnl_book_XYZ));
