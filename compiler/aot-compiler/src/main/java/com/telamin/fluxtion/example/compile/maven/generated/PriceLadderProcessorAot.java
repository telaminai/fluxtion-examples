 ...
 */
package com.telamin.fluxtion.example.compile.maven.generated;
...
public class PriceLadderProcessorAot
    implements CloneableDataFlow<PriceLadderProcessorAot>,
        /*--- @ExportService start ---*/
  ...
  private final transient SkewCalculator skewCalculator_2 =
      new com.telamin.fluxtion.example.compile.aot.node.SkewCalculator(midCalculator_3);;
  private final transient LevelsCalculator levelsCalculator_1 =
      new com.telamin.fluxtion.example.compile.aot.node.LevelsCalculator(skewCalculator_2);;
  private final transient PriceLadderPublisher priceLadderPublisher_0 =
      new com.telamin.fluxtion.example.compile.aot.node.PriceLadderPublisher(levelsCalculator_1);;
  ...
  public PriceLadderProcessorAot(Map<Object, Object> contextMap) {
    if (context != null) {
      context.replaceMappings(contextMap);
    }
    skewCalculator_2.setSkew(0);
  ...
  public PriceLadderProcessorAot() {
    this(null);
  }
  ...
  @Override
  public PriceLadderProcessorAot newInstance() {
    return new PriceLadderProcessorAot();
  }

  @Override
  public PriceLadderProcessorAot newInstance(Map<Object, Object> contextMap) {
    return new PriceLadderProcessorAot();
  }
